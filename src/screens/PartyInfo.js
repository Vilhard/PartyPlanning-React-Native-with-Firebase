...
export default function PartyInfo() {
  ...
  return (
    <View style={HomeStyles.partyContainer}>
      ...
      <Text style={HomeStyles.partyText}>
        Lisätietoa: <Text style={HomeStyles.partyText2}>{content}</Text>
      </Text>
      <Text style={HomeStyles.partyText}>
        Alkaa : <Text style={HomeStyles.partyText2}>{time}</Text>
      </Text>
      <Text style={HomeStyles.partyText}>
        Osoite: <Text style={HomeStyles.partyText2}>{location}</Text>
      </Text>
